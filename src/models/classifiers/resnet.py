...
from src.utils.normalization import norm_tensors
...
class ResNet(GeneralNet):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(ResNet, self).__init__(n_classes, n_channels, **kwargs)
        ...
        # self.conv1 = nn.Conv2d(self.n_channels_in, self.inplanes, kernel_size=7, stride=2, padding=3, bias=False)
        self.conv1 = nn.Conv2d(self.n_channels_in, self.inplanes, kernel_size=3, stride=1, padding=1, bias=False)
...
def _resnet(
    ...
    **kwargs: Any
    ...
    model = ResNet(n_classes, n_channels, block, layers, arch, **kwargs)
    if pretrained:
...
def resnext50_32x4d(n_classes: int,
                    n_channels: int,
                    pretrained: bool = False,
                    progress: bool = True,
                    **kwargs: Any
...
def resnext101_32x8d(n_classes: int,
                     n_channels: int,
                     pretrained: bool = False,
                     progress: bool = True,
                     **kwargs: Any
...
def wide_resnet50_2(n_classes: int,
                    n_channels: int,
                    pretrained: bool = False,
                    progress: bool = True,
                    **kwargs: Any
...
def wide_resnet101_2(n_classes: int,
                     n_channels: int,
                     pretrained: bool = False,
                     progress: bool = True,
                     **kwargs: Any
