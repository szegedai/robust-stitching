...
from src.models.classifiers.resnet import Add
...
class WideResNet(GeneralNet):
    ...
    def __init__(self,
        ...
        super().__init__(num_classes, num_input_channels, **kwargs)
        self.depth = depth
        self.width = width
    ...
    def name(self):
        ''' Name of the model '''
        return f"wide_resnet_{self.depth}_{self.width}"
...
class PreActResNet(GeneralNet):
    ...
    @property
    def name(self):
        return f"preactresnet{self.depth}"
