...
from src.models.frank.initializer import (AbsSemiMatchMaskInit, PsInvInit,
                                          SemiMatchMaskInit, identity_init,
                                          ones_w_zeros_b_init,
                                          permutation_init,
                                          random_permutation_mask_init,
                                          zeros_init)
...
class FrankeinsteinNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.seed = 0  # TODO: trainer.py needs this, should be refactored
    ...
    def get_layer(self, name):
        ...
        if name not in self.front_model.forward_order:
            return rgetattr(self.end_model, name)
